...
export function WelcomeBanner() {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-brand-900 via-brand-950 to-slate-900 text-white p-6 sm:p-8 shadow-xl border border-brand-500/20 mb-8">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-2 max-w-2xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md text-xs font-medium text-brand-200 border border-white/10">
        ...
        <div className="flex flex-wrap items-center gap-3 shrink-0">
          <Link
            href="/tasks"
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white text-brand-950 hover:bg-brand-50 font-semibold text-xs sm:text-sm shadow-md transition-all focus:outline-none focus:ring-2 focus:ring-white/40"
          >
