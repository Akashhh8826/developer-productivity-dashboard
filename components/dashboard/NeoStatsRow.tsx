  ...
  const statItems = [
    {
      ...
      colorClass: "bg-[#ff8585] text-slate-950",
    },
    {
      label: "Total Tasks",
      ...
      colorClass: "bg-[#fcd34d] text-slate-950",
    },
    {
      ...
      colorClass: "bg-[#c084fc] text-slate-950",
    },
    {
      label: "Pending Tasks",
      ...
      colorClass: "bg-[#fde047] text-slate-950",
    },
    {
      ...
      colorClass: "bg-[#7dd3fc] text-slate-950",
    },
  ];
