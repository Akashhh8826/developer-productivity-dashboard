...
export function RecentActivityCard() {
  ...
  return (
    <NeoCard
      ...
      headerRight={
        <span className="text-[11px] font-black px-2 py-0.5 rounded bg-[#34d399] text-slate-900 border border-slate-900 shadow-[1px_1px_0px_rgba(0,0,0,0.9)] cursor-pointer hover:bg-[#10b981] transition-colors">
          Live Stream
        </span>
      }
